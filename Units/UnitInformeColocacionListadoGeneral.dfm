object frmInformeColocacionesListadoGeneral: TfrmInformeColocacionesListadoGeneral
  Left = 308
  Top = 329
  BorderIcons = [biSystemMenu]
  BorderStyle = bsDialog
  Caption = 'Informe General de Colocaciones'
  ClientHeight = 111
  ClientWidth = 308
  Color = clBtnFace
  ...
  object Grupo: TRadioGroup
    ...
    ItemIndex = 0
    Items.Strings = (
      'N'#250'mero de Colocaci'#243'n'
      'N'#250'mero de Identificaci'#243'n'
      'Apellidos y Nombres'
      'Nombres y Apellidos'
      'Fecha de Apertura'
