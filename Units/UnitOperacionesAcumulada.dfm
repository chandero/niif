object frmOperacionesAcumuladas: TfrmOperacionesAcumuladas
  Left = 341
  Top = 291
  Width = 384
  Height = 182
  Caption = 'Operaciones M'#250'ltiples Superiores a'
  Color = clBtnFace
  ...
  object GroupBox2: TGroupBox
    ...
    Enabled = False
    TabOrder = 6
    object chkConsol: TCheckBox
      Left = 8
      Top = 18
      Width = 163
      Height = 17
      Caption = 'Consolidando Transacciones'
      TabOrder = 0
    end
    object chkAgrupar: TCheckBox
      ...
      Width = 157
      Height = 17
      Caption = 'Agrupando Transacciones'
      TabOrder = 1
    end
  ...
  object EdMontoI: TJvCurrencyEdit
    Left = 276
    Top = 6
    Width = 97
    Height = 21
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      ...
      'left join "cap$maestrotitular" on'
        ...
        '   ("caj$movimiento".ID_AGENCIA = "cap$maestrotitular".ID_AGENCI' +
        'A)'
      '   AND'
      
        '   ("caj$movimiento".ID_TIPO_CAPTACION = "cap$maestrotitular".ID' +
        '_TIPO_CAPTACION)'
      '   AND'
      
        '   ("caj$movimiento".NUMERO_CUENTA = "cap$maestrotitular".NUMERO' +
        '_CUENTA)'
      
        '   AND ("caj$movimiento".DIGITO_CUENTA = "cap$maestrotitular".DI' +
        'GITO_CUENTA)'
      'left join "gen$persona" on'
      
        '   ("cap$maestrotitular".ID_IDENTIFICACION = "gen$persona".ID_ID' +
        'ENTIFICACION)'
      '   AND'
      '   ("cap$maestrotitular".ID_PERSONA = "gen$persona".ID_PERSONA)'
      'where'
      '   "caj$movimiento".FECHA_MOV BETWEEN :FECHA1 and :FECHA2'
      '   and'
      '   "caj$movimiento".ID_TIPO_CAPTACION BETWEEN 1 and 6'
      '   and'
      ...
      '"gen$persona".SEGUNDO_APELLIDO,'
      '"gen$persona".NOMBRE,'
      '"caj$movremotoentrada".ID_TIPO_MOVIMIENTO,'
      '"caj$movremotoentrada".BILLETES'
      'from "caj$movremotoentrada"'
      'left join "cap$maestrotitular" on'
      
        '   ("caj$movremotoentrada".ID_AGENCIA = "cap$maestrotitular".ID_' +
        'AGENCIA)'
      '   AND'
      
        '   ("caj$movremotoentrada".ID_TIPO_CAPTACION = "cap$maestrotitul' +
        'ar".ID_TIPO_CAPTACION)'
      '   AND'
      
        '   ("caj$movremotoentrada".NUMERO_CUENTA = "cap$maestrotitular".' +
        'NUMERO_CUENTA)'
      
        '   AND ("caj$movremotoentrada".DIGITO_CUENTA = "cap$maestrotitul' +
        'ar".DIGITO_CUENTA)'
      'left join "gen$persona" on'
      ...
      '   ("cap$maestrotitular".ID_PERSONA = "gen$persona".ID_PERSONA)'
      'where'
      '   "caj$movremotoentrada".FECHA_MOV BETWEEN :FECHA1 and :FECHA2'
      '   and'
      '   "caj$movremotoentrada".ID_TIPO_CAPTACION BETWEEN 1 and 6'
      '   and'
      '   "cap$maestrotitular".NUMERO_TITULAR = 1')
    Left = 44
    Top = 19
        ...
        object prTxMemoObj24: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'INFORME DE OPERACIONES MULTIPLES EN EFECTIVO')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
  ...
  object IBQuery2: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select "col$colocacion".NUMERO_CUENTA,"gen$persona".ID_PERSONA,"' +
        'gen$persona".PRIMER_APELLIDO,"gen$persona".SEGUNDO_APELLIDO,"gen' +
        '$persona".NOMBRE,1 as ID_TIPO_MOVIMIENTO, "caj$movimientocol".BI' +
        'LLETES from "caj$movimientocol"'
      
        'left join "col$colocacion" on ("caj$movimientocol".ID_AGENCIA = ' +
        '"col$colocacion".ID_AGENCIA) AND ("col$colocacion".ID_COLOCACION' +
      ...
      'where "caj$movimientocol".FECHA_MOV BETWEEN :FECHA1  and :FECHA2')
    Left = 84
    Top = 18
    ParamData = <
      item
