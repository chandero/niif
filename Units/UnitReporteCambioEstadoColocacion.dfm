object frmReporteCambioEstadoColocacion: TfrmReporteCambioEstadoColocacion
  Left = 327
  Top = 196
  BorderStyle = bsDialog
  Caption = 'Reporte Cambios de Estado Cartera'
  ClientHeight = 119
  ClientWidth = 319
  Color = clBtnFace
  ...
  object IBQuery: TIBQuery
    ...
    SQL.Strings = (
      'SELECT'
      '"col$cambioestado".ID_AGENCIA,'
      '"col$cambioestado".ID_COLOCACION,'
      '"col$cambioestado".FECHA_CAMBIO,'
      '"col$cambioestado".ID_ESTADO_ACTUAL,'
      '"col$cambioestado".ID_ESTADO_NUEVO,'
      '"col$cambioestado".SALDO,'
      '"col$cambioestado".FECHA_CAPITAL,'
      '"col$cambioestado".FECHA_INTERES,'
      '"gen$persona".NOMBRE,'
      ...
      'FROM "col$cambioestado"'
      
        'INNER JOIN "col$colocacion" ON ("col$cambioestado".ID_AGENCIA="c' +
        'ol$colocacion".ID_AGENCIA)'
      
        'AND ("col$cambioestado".ID_COLOCACION="col$colocacion".ID_COLOCA' +
        'CION)'
      ...
      'AND ("col$colocacion".ID_PERSONA="gen$persona".ID_PERSONA)'
        ...
        'INNER JOIN "gen$empleado" ON ("col$cambioestado".ID_EMPLEADO="ge' +
        'n$empleado".ID_EMPLEADO)'
      'where'
      '("col$cambioestado".FECHA_CAMBIO BETWEEN :FECHA1 AND :FECHA2)'
      
        'order by "col$cambioestado".FECHA_CAMBIO, "col$cambioestado".ID_' +
        'COLOCACION')
    Left = 10
    Top = 75
    ParamData = <
  ...
  object Reporte: TprTxReport
    ...
    FromPage = 1
    ToPage = 1
    Title = 'Reporte Cambios de Estado Colocaciones'
    ExportFromPage = 0
    ExportToPage = 0
    Values = <>
    Variables = <
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'CAMBIOS DE ESTADO CARTERA DESDE: [:<yyyy/MM/dd>FechaI] HASTA [:<' +
                  'yyyy/MM/dd>FechaF]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
        ...
        object prTxMemoObj19: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[:<yyyy/MM/dd>IBQuery.FECHA_CAPITAL]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
