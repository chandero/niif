object frmSaldosCuentasconTarjetaDebito: TfrmSaldosCuentasconTarjetaDebito
  Left = 391
  Top = 306
  Width = 283
  Height = 112
  Caption = 'Saldos de Cuentas con Tarjeta D'#233'bito'
  Color = clBtnFace
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select * from SALDOS_CUENTAS_TARJETA(:FILTRO,:ANO,:FECHA1,:FECHA' +
        '2)')
    Left = 112
    Top = 8
    ParamData = <
        ...
        object prTxMemoObj3: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'SALDOS DE CUENTA CON TARJETA ACTIVA')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj10: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'FECHA DE PROCESO:[:<yyyy/mm/dd>FECHA]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
