object frmRecuperarLiquidacionColocacion: TfrmRecuperarLiquidacionColocacion
  Left = 287
  Top = 233
  Width = 355
  Height = 121
  Caption = 'Recuperaci'#243'n de Liquidaci'#243'n'
  Color = clBtnFace
  ...
  object EdColocacion: TLabeledEdit
    ...
    EditLabel.Width = 110
    EditLabel.Height = 13
    EditLabel.Caption = 'No. de Colocaci'#243'n:'
  ...
  object EdComprobante: TLabeledEdit
    Left = 140
    Top = 22
    Width = 58
    Height = 21
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      ...
      '           from "col$extracto"'
        ...
        '           left join "col$colocacion" on ("col$extracto".ID_COLO' +
        'CACION = "col$colocacion".ID_COLOCACION)'
      '           where'
      '           "col$extracto".ID_COLOCACION =:"ID_COLOCACION" and'
      
        '           "col$extracto".ID_CBTE_COLOCACION =:"ID_CBTE_COLOCACI' +
        'ON"')
    Left = 16
    Top = 48
    ParamData = <
