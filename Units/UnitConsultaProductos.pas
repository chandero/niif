...
uses
  ...
  IdComponent, IdTCPConnection, IdTCPClient, UnitDmGeneral;
...
begin
        ...
        IBllenaSolicitud.Database := dmGeneral.IBDatabase1;
        IBtranSolicitud.DefaultDatabase := dmGeneral.IBDatabase1;
        IBTransaction1.DefaultDatabase := dmGeneral.IBDatabase1;
        IBPersona.Database := dmGeneral.IBDatabase1;
        IBTPersona.DefaultDatabase := dmGeneral.IBDatabase1;

        IBDSTiposCaptacion.Database := dmGeneral.IBDatabase1;
        IBCaptaciones.Database := dmGeneral.IBDatabase1;
        IBConsulta.Database := dmGeneral.IBDatabase1;
        IBConsulta1.Database := dmGeneral.IBDatabase1;
        IBConsulta2.Database := dmGeneral.IBDatabase1;
        IBSaldosMes.Database := dmGeneral.IBDatabase1;
        IBTablaLiquidacion.Database := dmGeneral.IBDatabase1;
        IBTablaLiquidacionColocacion.Database := dmGeneral.IBDatabase1;
        IBObservaciones.Database := dmGeneral.IBDatabase1;
        IBFormas.Database := dmGeneral.IBDatabase1;
        IBColocaciones.Database := dmGeneral.IBDatabase1;
        IBFianzas.Database := dmGeneral.IBDatabase1;
        IBSQL.Database := dmGeneral.IBDatabase1;
        IBSQL1.Database := dmGeneral.IBDatabase1;
        IBSQL2.Database := dmGeneral.IBDatabase1;
        IBDeudaHoy.Database := dmGeneral.IBDatabase1;

        IBDSTiposCaptacion.Transaction := dmGeneral.IBTransaction1;
        IBCaptaciones.Transaction := dmGeneral.IBTransaction1;
        IBConsulta.Transaction := dmGeneral.IBTransaction1;
        IBConsulta1.Transaction := dmGeneral.IBTransaction1;
        IBConsulta2.Transaction := dmGeneral.IBTransaction1;
        IBSaldosMes.Transaction := dmGeneral.IBTransaction1;
        IBTablaLiquidacion.Transaction := dmGeneral.IBTransaction1;
        IBTablaLiquidacionColocacion.Transaction := dmGeneral.IBTransaction1;
        IBObservaciones.Transaction := dmGeneral.IBTransaction1;
        IBFormas.Transaction := dmGeneral.IBTransaction1;
        IBColocaciones.Transaction := dmGeneral.IBTransaction1;
        IBFianzas.Transaction := dmGeneral.IBTransaction1;
        ...
        IBDeudaHoy.Transaction := dmGeneral.IBTransaction1;
