object frmInformeAuxiliares: TfrmInformeAuxiliares
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      ...
      '"con$tercerosaldoinicial".SALDO AS TERCEROSALDO  '
      'from "con$auxiliar"'
        ...
        'LEFT JOIN "con$tercerosaldoinicial" ON ("gen$persona".ID_IDENTIF' +
        'ICACION = "con$tercerosaldoinicial".ID_IDENTIFICACION and '
      
        '"gen$persona".ID_PERSONA = "con$tercerosaldoinicial".ID_PERSONA ' +
        'and "con$puc".CODIGO = "con$tercerosaldoinicial".CODIGO and "con' +
        '$tercerosaldoinicial".ANHO = :ANHO)'
      'where'
    ...
    object IBQuery1TERCEROSALDO: TIBBCDField
      FieldName = 'TERCEROSALDO'
      Origin = '"con$tercerosaldoinicial"."SALDO"'
      Precision = 18
      Size = 3
    end
  end
