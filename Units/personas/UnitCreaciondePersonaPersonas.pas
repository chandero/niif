...
uses UnitGlobales, UnitdmPersona;
...
begin
        ...
        dmPersona.IBQuery.Transaction.Active := True;
        if dmPersona.IBQuery.Transaction.InTransaction then
           dmPersona.IBQuery.Transaction.Rollback;
        dmPersona.IBQuery.Transaction.StartTransaction;
...
begin
        dmPersona.IBQuery.Transaction.Active := False;
        dmPersona.Free;
end;
...
I : integer;
begin
     with dmPersona do begin
        IBQuery1.Transaction := IBTPersonas;
        IBDStiposidentificacion.Transaction := IBTPersonas;
        IBDStiposrelacion.Transaction := IBTPersonas;
        IBDStiposciiu.Transaction := IBTPersonas;
        IBDStipopersona.Transaction := IBTPersonas;
        IBDSestadocivil.Transaction := IBTPersonas;
        IBDStiposidentificacionconyuge.Transaction := IBTPersonas;
        IBDStipodireccion.Transaction := IBTPersonas;
        IBDStiporeferencia.Transaction := IBTPersonas;
        IBDSparentesco.Transaction := IBTPersonas;
        ...
        IBDStiposidentificacion.Open;
        IBDStiposidentificacion.Last;
        IBDStiposidentificacion.First;
        IBDStiposrelacion.Open;
        IBDStiposrelacion.Last;
        IBDStiposrelacion.First;
        IBDStiposciiu.Open;
        IBDStiposciiu.Last;
        IBDStiposciiu.First;
        IBDStipopersona.Open;
        IBDStipopersona.Last;
        IBDStipopersona.First;
        IBDSestadocivil.Open;
        IBDSestadocivil.Last;
        IBDSestadocivil.First;
        IBDStiposidentificacionconyuge.Open;
        IBDStiposidentificacionconyuge.Last;
        IBDStiposidentificacionconyuge.First;
        IBDStipodireccion.Open;
        IBDStipodireccion.Last;
        IBDStipodireccion.First;
        IBDStiporeferencia.Open;
        IBDStiporeferencia.Last;
        IBDStiporeferencia.First;
        IBDSparentesco.Open;
        IBDSparentesco.Last;
        IBDSparentesco.First;
       end;
...
// valores iniciales información referencias
        ...
        if ((Id <> 0) and (id <> 4) or (id <> 7)) and (Documento <> '') then
         begin
...
begin
        EdDescripcionIngresosConyuge.Text := vDescripcionIngresos;
        EdDescripcionIngresosConyuge.SelStart := 0;
end;
...
begin
      ...
      try
           ...
           SQL.Add('"gen$persona"."MATRICULA_MERCANTIL")');
           SQL.Add('values (');
           ...
           SQL.Add(':"CAPITAL_SOCIAL", :"MATRICULA_MERCANTIL")');
          ...
          if (vTipoIdentificacion = 4) or (vTipoIdentificacion = 7) then
           begin
             ...
             ParamByName('FECHA_EXPEDICION').Clear;
           ...
           ImgFotoC.Picture.SaveToFile('C:\Foto.bmp');
           ImgFirmaC.Picture.SaveToFile('C:\Firma.bmp');
//           ParamByName('FOTO').LoadFromFile('C:\Foto.bmp',ftBlob);
//           ParamByName('FIRMA').LoadFromFile('C:\Firma.bmp',ftBlob);
...
//           ImgFotoC.Picture.Bitmap.SaveToFile('C:\Foto.bmp');
//           ImgFirmaC.Picture.Bitmap.SaveToFile('C:\Firma.bmp');
