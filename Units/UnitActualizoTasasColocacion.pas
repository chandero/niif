...
uses
  ...
  IBCustomDataSet, IBTable, Grids, DBGrids, Math, IBQuery, DBCtrls, UnitDmGeneral,UnitDmColocacion;
...
begin
        ...
        IBDtf.Database := dmGeneral.IBDatabase1;
        IBOrdinaria.Database := dmGeneral.IBDatabase1;
        IBConsultar.Database := dmGeneral.IBDatabase1;
        DsetFija.Database := dmGeneral.IBDatabase1;
        DsetDtf.Database := dmGeneral.IBDatabase1;

        IBDtf.Transaction := dmGeneral.IBTransaction1;
        IBOrdinaria.Transaction := dmGeneral.IBTransaction1;
        IBConsultar.Transaction := dmGeneral.IBTransaction1;
        DsetFija.Transaction := dmGeneral.IBTransaction1;
        DsetDtf.Transaction := dmGeneral.IBTransaction1;
