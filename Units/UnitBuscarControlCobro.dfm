object frmBusquedaControlCobro: TfrmBusquedaControlCobro
  Left = 164
  Top = 210
  ...
  object IBQuery: TIBQuery
    ...
    ForcedRefresh = True
    AfterScroll = IBQueryAfterScroll
    SQL.Strings = (
      'SELECT '
      ...
      '"col$colocacion".VALOR_CUOTA,'
        ...
        '"col$colocacion".VALOR_DESEMBOLSO - "col$colocacion".ABONOS_CAPI' +
        'TAL AS SALDO,'
      ...
      'WHERE '
      '("col$colocacion".ID_IDENTIFICACION = :"ID_IDENTIFICACION") AND '
      '("col$colocacion".ID_PERSONA = :"ID_PERSONA")'
      'ORDER BY '
      
        '"col$colocacion".ID_ESTADO_COLOCACION,"col$colocacion".ID_COLOCA' +
        'CION ')
    Left = 332
    Top = 86
    ParamData = <
