object frmTarjetasBloqueadas: TfrmTarjetasBloqueadas
  Left = 346
  Top = 305
  Width = 387
  Height = 122
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'INFORME DE TARJETA DEBITO BLOQUEADAS ENTRE EL [:<yyyy/mm/dd>F_IN' +
                  'ICIAL] Y EL [:<yyyy/mm/dd>F_FINAL]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
        ...
        object prTxMemoObj17: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'TOTAL TARJETAS BLOQUEADAS: [:<#,0>TARJETAS]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
  ...
  object prReport1: TprReport
    Title = 'TARJETAS DEBITO CANCELADAS EN EL PERIODO'
    Values = <
      item
        Name = 'TARJETAS'
        AggFunction = prafCount
        ...
        object prMemoObj2: TprMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'INFORME TARJETAS DEBITO BLOQUEADAS')
              lBorder.Show = False
              lBorder.Style = psSolid
              lBorder.Color = clBlack
              lBorder.Width = 1
        ...
        object prMemoObj23: TprMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                ' ENTRE EL [:<yyyy/mm/dd>F_INICIAL] Y EL [:<yyyy/mm/dd>F_FINAL]')
              lBorder.Show = False
              lBorder.Style = psSolid
              lBorder.Color = clBlack
              lBorder.Width = 1
