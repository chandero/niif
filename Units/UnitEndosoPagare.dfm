object FrmEndosoPagare: TFrmEndosoPagare
  Left = 201
  Top = 171
  Width = 450
  Height = 194
  BorderIcons = [biSystemMenu]
  Caption = 'Endososo de Pagares'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object JVdesembolso: TJvStaticText
      Left = 255
      Top = 61
      Width = 102
      Height = 21
  ...
  object panel2: TPanel
    ...
    object DBentidad: TDBLookupComboBox
      ...
      TabOrder = 0
      OnEnter = DBentidadEnter
      OnExit = DBentidadExit
      OnKeyPress = DBentidadKeyPress
    end
    object EDexterno: TEdit
      Left = 332
      Top = 10
      Width = 105
      Height = 21
      TabOrder = 1
      OnKeyPress = EDexternoKeyPress
    end
  end
