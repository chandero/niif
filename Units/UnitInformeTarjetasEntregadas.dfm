object frmTarjetasEntregadas: TfrmTarjetasEntregadas
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'INFORME DE TARJETA DEBITO ENTREGADAS ENTRE EL [:<yyyy/mm/dd>F_IN' +
        ...
        object prTxMemoObj17: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'TOTAL TARJETAS ENTREGADAS: [:<#,0>TARJETAS]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
  ...
  object prReport1: TprReport
    Title = 'TARJETAS DEBITO ENTREGADAS EN EL PERIODO'
    Values = <
      item
        Name = 'TARJETAS'
        AggFunction = prafCount
        ...
        object prMemoObj2: TprMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'INFORME TARJETAS DEBITO ENTREGADAS')
              lBorder.Show = False
              lBorder.Style = psSolid
              lBorder.Color = clBlack
              lBorder.Width = 1
