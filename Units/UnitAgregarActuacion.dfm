object frmAgregarActuacion: TfrmAgregarActuacion
  Left = 359
  Top = 232
  Width = 379
  Height = 170
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 107
      Height = 13
      Caption = 'Fecha de la Actuaci'#243'n'
    end
    ...
    object CBtipoAct: TDBLookupComboBox
      Left = 123
      Top = 15
      Width = 131
      Height = 21
  ...
  object IBActuacion: TIBQuery
    SQL.Strings = (
      'select * from "col$actuacionproceso"')
    Left = 256
  end
